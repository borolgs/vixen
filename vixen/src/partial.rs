...
impl Part {
    ...
    /// the same content as part of a full page.
...
/// as written (`"#list"`, `"closest form"`). Types declared with
/// [`#[id]`](macro@crate::id), including ids generated by
/// [`#[fragment]`](macro@crate::fragment), convert to their `#id` selector.
#[derive(Clone)]
